...
exports.createRateLimiterOptions = (limit, count, options) => {
...
exports.createJobOptions = (options = {}) => ({
    id: String(Date.now()),
    ...options,
    weight: 1,
});
exports.chainRateLimiters = (rl) => {
...
exports.secsToMs = (secs) => secs * 1000;
exports.toNumber = (n) => Number(n);
exports.extractRateLimits = (headers) => ({
